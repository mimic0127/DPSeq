...
parser.add_argument('--TCGA_folder_path',type=str, default="/data/cm/NLP_based_model_code/data/TCGA_MSI_patch", help='patch path for test')
parser.add_argument('--MCO_MSS_path',type=str, default="/data/cm/NLP_based_model_code/data/MCO_MSS",help='patch path for train with status-0')
parser.add_argument('--MCO_MSI_path',type=str, default="/data/cm/NLP_based_model_code/data/MCO_MSI",help='patch path for train with status-1')
parser.add_argument('--model_name',type=str, default='CMT', help='model name')
...
# DPSeq
class DPSeq(nn.Module):
    def __init__(self):
        super(DPSeq, self).__init__()
